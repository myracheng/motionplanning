...
pixels = 40   # pixels
env_height = 100  # grid height
env_width = 100  # grid width
...
class Environment(tk.Tk, object):
    ...
    def build_environment(self):
        ...
        self.obstacle1 = self.canvas_widget.create_image(pixels * 1, pixels * 4, anchor='nw', image=self.obstacle1_object)
